    ...
    >
      ...
      <div className="flex flex-col gap-6 items-center justify-center w-full">
        ...
        <GlassButton href="https://x.com/notsurajgaud">
          <div className="text-xl text-white" style={{ textShadow: '0 4px 12px rgba(0,0,0,0.9), 0 2px 6px rgba(0,0,0,0.7), 0 1px 3px rgba(0,0,0,0.5)' }}>
...
// Animated Background Wrapper - Creates the moving background effect (slow & lazy)
const LiquidGlassAnimatedBackground: React.FC<{
  children: React.ReactNode;
  className?: string;
}> = ({ children, className = "" }) => (
  <div
...
// Section Header Card Component - Custom for Florida Local
export const LiquidGlassHeaderCard: React.FC<{
  title: string;
  subtitle?: string;
  className?: string;
...
export { GlassEffect, GlassDock, GlassButton, GlassFilter, LiquidGlassAnimatedBackground };
