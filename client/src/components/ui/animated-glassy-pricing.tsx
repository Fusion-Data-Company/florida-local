...
export const ModernPricingPage = ({
  ...
  return (
    <section className="relative bg-background text-foreground w-full overflow-hidden min-h-[600px]">
      {showAnimatedBackground && <ShaderCanvas />}
      <div className="relative w-full flex flex-col items-center px-4 py-16 md:py-20 z-10">
