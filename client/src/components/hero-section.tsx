  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden miami-hero-section">
      ...
      <div className="relative z-10 text-center text-slate-900 max-w-4xl mx-auto px-4">
        ...
        <h1 className="text-5xl md:text-7xl font-serif font-bold mb-6 leading-tight text-slate-900 miami-heading entrance-fade-up">
        ...
        <p className="text-xl md:text-2xl mb-8 text-slate-800 max-w-2xl mx-auto leading-relaxed miami-body-text entrance-fade-up stagger-1">
        ...
        <motion.div
          ...
          className="flex flex-wrap justify-center gap-6 mb-12 text-slate-700"
        >
          <div className="flex items-center gap-2 bg-white/60 backdrop-blur-sm px-4 py-2 rounded-full shadow-md hover:shadow-lg transition-all duration-300">
            <Star className="w-5 h-5 text-yellow-500" />
            <span className="font-semibold">{totalBusinesses.toLocaleString()}</span>
